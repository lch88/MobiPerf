 ...
 * interface is simple: a process method that works on an be.hogent.tarsos.dsp.AudioEvent object.
 * The be.hogent.tarsos.dsp.AudioEvent contains a buffer with some floats and the same information in
 * raw bytes.
 * </p> 
 * <p>
...
public interface AudioProcessor {
    ...
    /**
     * Notify the be.hogent.tarsos.dsp.AudioProcessor that no more data is available and processing
